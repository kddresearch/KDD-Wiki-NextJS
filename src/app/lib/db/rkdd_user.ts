...
async function insert(user: rKddUser) :Promise<rKddUser> {
    ...
    const query_str: string = `
        ...
        RETURNING *
    `
    const values: any[] = [user.username, user.access_level, user.settings, user.first_name, user.last_name, user.bio, user.email, user.profile_picture, user.phone_number, user.social_media];
...
async function update(user: rKddUser) :Promise<rKddUser> {
    ...
    const query_str: string = `
        ...
        RETURNING *
    `
    const values: any[] = [user.username, user.access_level, user.settings, user.first_name, user.last_name, user.bio, user.email, user.profile_picture, user.phone_number, user.social_media, user.id];
